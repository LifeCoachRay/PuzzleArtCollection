...
rush.Platform = (function(){
  ...
  p.initialize = function(width) {
    ...
    if (width === 120) {
      var image = new createjs.Bitmap("platform.png");
      this.addChild(image);
    } else if (width > 120) {
      var imageLeft = new createjs.Bitmap("platform-left.png");
      this.addChild(imageLeft); // width 57
      var imageRight = new createjs.Bitmap("platform-right.png");
      this.addChild(imageRight); // width 62
      var imageMiddle = new createjs.Bitmap("platform-middle.png");
